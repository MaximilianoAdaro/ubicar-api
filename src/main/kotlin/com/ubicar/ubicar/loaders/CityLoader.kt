...
@Profile("!test")
@Component
class CityLoader(private val cityRepository: CityRepository, private val stateRepository: StateRepository) :
  CommandLineRunner, Ordered {

  override fun run(vararg args: String?) {
    val state: State =
      stateRepository.findFirstByName("Buenos Aires").orElseThrow { NotFoundException("State not found") }
