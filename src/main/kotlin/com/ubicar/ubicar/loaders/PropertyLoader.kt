...
//            amenitiesRepository.findById(0).get(),
//            amenitiesRepository.findById(4).get(),
//            amenitiesRepository.findById(9).get(),
//            amenitiesRepository.findById(15).get(),
//            amenitiesRepository.findById(19).get(),
//            amenitiesRepository.findById(20).get(),
//            amenitiesRepository.findById(25).get()
//        )
//        val materials: MutableList<ConstructionMaterial> =
//            mutableListOf(materialRepository.findById(35).get(), materialRepository.findById(36).get())
...
//                mutableListOf(Contact(0, "Agente", "agente@gmail.com")),
//                mutableListOf(OpenHouseDate(0, LocalDate.now(), LocalTime.NOON, LocalTime.MIDNIGHT)),
...
//            amenitiesRepository.findById(2).get(),
//            amenitiesRepository.findById(8).get(),
//            amenitiesRepository.findById(9).get(),
//            amenitiesRepository.findById(13).get(),
//            amenitiesRepository.findById(25).get(),
//            amenitiesRepository.findById(26).get(),
//            amenitiesRepository.findById(32).get()
//        )
//        val materials2: MutableList<ConstructionMaterial> =
//            mutableListOf(materialRepository.findById(37).get(), materialRepository.findById(38).get())
//        val securities2: MutableList<SecurityMeasure> = mutableListOf(securityRepository.findById(40).get())
//        properties.add(
//            Property(
//                0,
//                "Depto muy top en la mejor zona de Belgrano",
//                25000000,
//                Condition.SALE,
...
//                mutableListOf(Contact(0, "Vendedor", "dueña_de_depto_top@gmail.com")),
//                mutableListOf(OpenHouseDate(0, LocalDate.now(), LocalTime.NOON, LocalTime.MIDNIGHT)),
