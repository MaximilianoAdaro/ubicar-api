...
class PropertyLoader(private val propertyService: PropertyService,
    ...
    override fun run(vararg args: String?) {
        ...
        val amenities: MutableList<Amenity> = mutableListOf(amenitiesRepository.findById(0).get(), amenitiesRepository.findById(4).get(), amenitiesRepository.findById(9).get(), amenitiesRepository.findById(15).get(), amenitiesRepository.findById(19).get(), amenitiesRepository.findById(20).get(), amenitiesRepository.findById(25).get())
